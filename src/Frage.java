...
class Mehrfachauswahl extends Frage{
    ...
    String[] antworten;
    int anzahlLoesungen;
    int indexRichtigeLoesungen;
    public Mehrfachauswahl(String test, int punkte, String[] antworten, int indexRichtigeLoesungen, int anzahlLoesungen){
        super(test, punkte);
        this.antworten = antworten;
        this.indexRichtigeLoesungen = indexRichtigeLoesungen;
...
class Pruefung {
    ...
    public Frage frageErzeugen(int nummer) {
        ...
        int typ = IO.readInt("Fragetyp: Wahr/Falsch (1), Multiple Choice (2), Mehrfachauswahl (3)?");
        switch (typ) {
            case 1:
    ...
    void ergebnisseBekanntgeben() {
        ...
        IO.println("-------------------");
        IO.println("Quiz: " + this.pruefung.getTitel());for (int i = 0; i < this.studenten.length; i++) {
    ...
    private void ranglisteErstellen() {
        ...
        do {
            ...
            for (int i = 0; i < this.studenten.length - 1; i++) {
                if (this.studenten[i].getPunkte() < this.studenten[i
                        + 1]
                        .getPunkte()) {
